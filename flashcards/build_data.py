...
BALANCING_APPLICATION_QUESTIONS = [
    rebuilt_question("Balansering: regresjon", "Hva er hovedforskjellen mellom bivariat og multippel regresjon?", "Multippel regresjon inkluderer flere forklaringsvariabler enn bivariat regresjon.", ["Bivariat regresjon kan aldri ha konstantledd.", "Multippel regresjon brukes bare med kategoriske variabler.", "Bivariat regresjon gir alltid kausale estimater.", "Multippel regresjon kan ikke ha residualer."], "Bivariat regresjon ser på én X og én Y, mens multippel regresjon inkluderer flere X-er."),
    rebuilt_question("Balansering: regresjon", "En koeffisient på X er -3 i en multippel regresjon. Hva er beste tolkning?", "Når X øker med én enhet, forventes Y å falle med 3, gitt de andre variablene i modellen.", ["Når Y øker med én enhet, faller X med 3.", "X forklarer 3 prosent av variasjonen i Y.", "Resultatet er alltid statistisk signifikant.", "Modellen er nødvendigvis kausal."], "Regresjonskoeffisienten tolkes som forventet endring i Y per enhets endring i X, alt annet i modellen holdt konstant."),
    rebuilt_question("Balansering: regresjon", "Hvorfor kan konstantleddet noen ganger være lite substantivt interessant?", "Fordi X = 0 kan være en urealistisk eller meningsløs verdi.", ["Fordi konstantleddet alltid er feil estimert.", "Fordi konstantleddet aldri brukes i prediksjon.", "Fordi konstantleddet er det samme som R².", "Fordi konstantleddet bare finnes i eksperimenter."], "Konstantleddet er forventet Y når alle X-er er null; dette kan være meningsløst hvis null ikke er relevant."),
    rebuilt_question("Balansering: regresjon", "En koeffisient for X endres mye når Z legges inn som kontroll. Hva kan det tyde på?", "Z kan ha vært en viktig bakenforliggende variabel eller kontrollvariabel.", ["X er nødvendigvis randomisert.", "Y er nødvendigvis feil målt.", "R² må være null.", "Det finnes ikke lenger residualer."], "Hvis kontroll for Z endrer X-koeffisienten mye, kan Z ha forklart noe av den opprinnelige sammenhengen."),
    rebuilt_question("Balansering: regresjon", "Når gir en utelatt variabel skjevhet i en regresjonskoeffisient?", "Når variabelen påvirker Y og er korrelert med en inkludert X.", ["Når variabelen er irrelevant for Y.", "Når utvalget er større enn 100.", "Når variabelen bare har tekstnavn.", "Når R² er over 0,5."], "Utelatt variabelskjevhet krever både relevans for Y og samvariasjon med X."),
    rebuilt_question("Balansering: regresjonsdiagnostikk", "Et residualplott viser større spredning i residualene når X øker. Hva tyder dette på?", "Heteroskedastisitet.", ["Perfekt multikollinearitet.", "Random assignment.", "Høy begrepsvaliditet.", "At R² må være 1."], "Heteroskedastisitet betyr at residualenes varians varierer på tvers av X-verdier eller observasjoner."),
    rebuilt_question("Balansering: regresjonsdiagnostikk", "Hva er riktig om en observasjon med høy leverage?", "Den har uvanlige X-verdier, men trenger ikke ha stor residual.", ["Den har alltid størst Y-verdi.", "Den er alltid en målefeil.", "Den gjør automatisk modellen kausal.", "Den må fjernes uten videre."], "Leverage handler om plassering i X-rommet, ikke nødvendigvis om avvik i Y."),
    rebuilt_question("Balansering: regresjonsdiagnostikk", "Hva bør en forsker gjøre med en observasjon med høy Cook's distance?", "Undersøke om observasjonen påvirker resultatet uforholdsmessig mye.", ["Alltid slette observasjonen uten begrunnelse.", "Tolke den som en p-verdi.", "Bruke den som referansekategori.", "Anta at den beviser kausalitet."], "Cook's distance brukes til å vurdere hvor mye én observasjon påvirker regresjonsresultatet."),
    rebuilt_question("Balansering: regresjon", "Hvorfor kan standardiserte koeffisienter være nyttige?", "De gjør det lettere å sammenligne variabler målt på ulike skalaer.", ["De garanterer intern validitet.", "De fjerner alle målefeil.", "De gjør p-verdien lik R².", "De kan bare brukes med nominaldata."], "Standardiserte koeffisienter uttrykker endring i standardavvik, ikke opprinnelige enheter."),
    rebuilt_question("Balansering: regresjon", "Hva kan det bety hvis justert R² faller når en variabel legges til?", "Den nye variabelen bidrar lite relativt til modellens økte kompleksitet.", ["Den nye variabelen er nødvendigvis kausal.", "Den nye variabelen er perfekt målt.", "Alle tidligere koeffisienter blir ugyldige.", "Utvalget er blitt representativt."], "Justert R² straffer ekstra variabler som ikke forbedrer modellen nok."),
    rebuilt_question("Balansering: regresjon", "I en modell med partivalg som fire kategorier og konstantledd, hvor mange dummyer bør vanligvis inkluderes?", "Tre.", ["Én.", "Fire.", "Fem.", "Ingen, fordi dummyer ikke kan brukes."], "Med konstantledd må én kategori være referansekategori, så k kategorier gir k - 1 dummyer."),
    rebuilt_question("Balansering: regresjon", "Hva betyr referansekategorien i en dummyregresjon?", "Kategorien de inkluderte dummykoeffisientene sammenlignes med.", ["Kategorien som alltid har størst effekt.", "Kategorien som fjernes fra datasettet.", "Kategorien som er avhengig variabel.", "Kategorien som bestemmer standardfeilen alene."], "Dummykoeffisienter tolkes relativt til den utelatte referansekategorien."),
    rebuilt_question("Balansering: regresjon", "En lineær sannsynlighetsmodell gir koeffisienten 0,25. Hva betyr det?", "25 prosentpoeng høyere forventet sannsynlighet.", ["25 prosent høyere standardfeil.", "0,25 høyere R² med sikkerhet.", "25 flere observasjoner.", "At prediksjonen alltid ligger mellom 0 og 1."], "Når Y er binær, tolkes OLS-koeffisienter som endringer i sannsynlighet/prosentpoeng."),
    rebuilt_question("Balansering: samspill", "Hva betyr det hvis effekten av utdanning på valgdeltakelse er sterkere blant eldre enn yngre?", "Det er et samspill mellom utdanning og alder.", ["Det er nødvendigvis heteroskedastisitet.", "Det er en ren referansekategori.", "Det er alltid lav reliabilitet.", "Det er bare et kakediagram."], "Samspill betyr at effekten av én variabel varierer med verdien på en annen."),
    rebuilt_question("Balansering: regresjon", "Hva endres vanligvis når man bruker robuste standardfeil?", "Usikkerhetsberegningen rundt koeffisientene.", ["Selve Y-verdiene i datasettet.", "Hvilke observasjoner som er randomisert.", "Begrepenes validitet.", "Koeffisientenes kausale identifikasjon."], "Robuste standardfeil justerer standardfeil, ikke automatisk kausal tolkning eller målevaliditet."),
    rebuilt_question("Balansering: inferens og regning", "En koeffisient har t-verdi 2,1. Hva antyder det ofte ved vanlig 5-prosentnivå?", "At koeffisienten ofte regnes som statistisk signifikant forskjellig fra null.", ["At effekten er bevist kausal.", "At R² er 2,1.", "At nullhypotesen er sann.", "At standardfeilen er null."], "En vanlig tommelfingerregel er at absolutt t-verdi rundt eller over 2 ofte er signifikant på 5-prosentnivå."),
    rebuilt_question("Balansering: inferens og regning", "En p-verdi er 0,049. Hva er riktig ved 5-prosentnivå?", "Resultatet er akkurat under grensen og regnes vanligvis som signifikant.", ["Resultatet er ikke signifikant fordi 0,049 er større enn 0,05.", "Nullhypotesen er bevist sann.", "Effekten er nødvendigvis stor.", "Målingen er nødvendigvis valid."], "0,049 er lavere enn 0,05, men forskjellen mellom 0,049 og 0,051 bør ikke overtolkes substantielt."),
    rebuilt_question("Balansering: inferens og regning", "En p-verdi er 0,20. Hva er beste tolkning?", "Vi har ikke sterk statistisk evidens mot nullhypotesen ved vanlige nivåer.", ["Nullhypotesen er bevist sann.", "Effekten er 20 prosent stor.", "Resultatet er alltid kausalt.", "R² er 0,20."], "P = 0,20 er høyere enn vanlige signifikansnivåer som 0,05."),
    rebuilt_question("Balansering: inferens og regning", "Et estimat er 4 og standardfeilen er 1,5. Hva er et omtrent 95-prosent konfidensintervall?", "[1; 7].", ["[2,5; 5,5].", "[0; 8].", "[4; 5,5].", "[-1,5; 1,5]."], "Bruk estimat ± 2 × standardfeil: 4 ± 3 gir omtrent [1; 7]."),
    rebuilt_question("Balansering: inferens", "Hva betyr det hvis én koeffisient har standardfeil 0,5 og en annen har standardfeil 2?", "Den første er estimert mer presist, alt annet likt.", ["Den første er nødvendigvis mer kausal.", "Den andre har alltid høyere validitet.", "Begge har samme usikkerhet.", "Standardfeil kan ikke sammenlignes."], "Lavere standardfeil betyr mindre estimatusikkerhet, men ikke automatisk større substansiell betydning."),
    rebuilt_question("Balansering: inferens", "Hva betyr et signifikansnivå på 5 prosent i hypotesetesting?", "Forskeren aksepterer en Type I-feilrate på 5 prosent ved gjentatt bruk av testregelen.", ["Forskeren er 95 prosent sikker på at hypotesen er sann.", "Effekten må forklare minst 5 prosent av Y.", "Alle resultater under 5 prosent er kausale.", "Fem observasjoner fjernes fra analysen."], "Signifikansnivået er terskelen for å forkaste H0 og knyttes til Type I-feil."),
    rebuilt_question("Balansering: inferens", "Hvis man tester 100 sanne nullhypoteser på 5-prosentnivå, hva kan man omtrent forvente?", "Omtrent 5 falske positive funn.", ["Omtrent 95 falske positive funn.", "Ingen falske positive funn.", "Alle effekter blir kausale.", "R² blir omtrent 5."], "Ved 5-prosentnivå vil testregelen i gjennomsnitt feilaktig forkaste rundt 5 av 100 sanne nullhypoteser."),
    rebuilt_question("Balansering: inferens", "Hva er forskjellen mellom standardavvik og standardfeil?", "Standardavvik beskriver spredning i data; standardfeil beskriver usikkerhet i et estimat.", ["De betyr alltid det samme.", "Standardfeil beskriver bare medianen.", "Standardavvik er en p-verdi.", "Standardfeil måler begrepsvaliditet."], "Dette skillet er sentralt: variasjon i observasjoner er ikke det samme som usikkerhet om estimatet."),
    rebuilt_question("Balansering: inferens", "Hva skjer ofte med konfidensintervallet når utvalgsstørrelsen øker?", "Det blir smalere fordi standardfeilen ofte blir mindre.", ["Det blir alltid bredere.", "Det forsvinner.", "Det gjør effekten kausal.", "Det blir uavhengig av estimatet."], "Større N gir ofte mer presise estimater og dermed smalere intervaller."),
    rebuilt_question("Balansering: inferens", "Hvorfor bør man skille mellom statistisk signifikans og effektstørrelse?", "En effekt kan være statistisk tydelig, men liten i praksis.", ["Signifikans betyr alltid stor effekt.", "Effektstørrelse kan aldri måles.", "P-verdi er det samme som koeffisient.", "R² beviser alltid kausalitet."], "Store utvalg kan gjøre små effekter signifikante; substansiell vurdering krever effektstørrelse."),
    rebuilt_question("Balansering: kausalitet og design", "Hvorfor er tidsrekkefølge viktig for kausalitet?", "Årsaken må komme før virkningen.", ["Virkningen må alltid komme før årsaken.", "Tidsrekkefølge erstatter behovet for samvariasjon.", "Tidsrekkefølge gjør alle mål valide.", "Tidsrekkefølge er bare relevant for kakediagram."], "En årsak kan ikke forklare et utfall som allerede har skjedd."),
    rebuilt_question("Balansering: kausalitet og design", "Hva kan være problemet med å kontrollere for en mediator mellom X og Y?", "Man kan kontrollere bort en del av effekten man egentlig vil forklare.", ["Man får alltid bedre total effekt.", "Man sikrer random sampling.", "Man gjør standardfeilen null.", "Man unngår all målefeil."], "En mediator ligger på kausalveien. Kontroll for den kan endre estimatet fra total effekt til direkte effekt."),
    rebuilt_question("Balansering: kausalitet og design", "En survey trekker respondenter tilfeldig fra folkeregisteret, men behandling gis ikke tilfeldig. Hva har studien særlig styrket?", "Ekstern validitet/representativitet, ikke nødvendigvis intern kausal validitet.", ["Random assignment.", "Perfekt intern validitet.", "At alle konfunderende variabler er fjernet.", "At p-verdier ikke trengs."], "Tilfeldig trekking styrker generalisering, mens tilfeldig tilordning styrker kausal sammenligning."),
    rebuilt_question("Balansering: kausalitet og design", "Hva trues særlig av stort frafall eller ikke-svar i et utvalg?", "Ekstern validitet og representativitet.", ["At residualer kan beregnes.", "At X kommer før Y.", "At dummyvariabler kan brukes.", "At R² eksisterer."], "Hvis de som svarer skiller seg systematisk fra de som ikke svarer, kan generalisering bli svakere."),
    rebuilt_question("Balansering: kausalitet og design", "Hvorfor kan en regelendring eller institusjonell grense være nyttig i et kvasi-eksperiment?", "Den kan skape behandlingslignende variasjon uten full random assignment.", ["Forskeren velger alltid selv hvem som får behandling.", "Alle variabler må være nominale.", "Det finnes aldri sammenligningsgrunnlag.", "Data kan ikke analyseres statistisk."], "Kvasi-eksperimenter forsøker å etterligne noe av logikken i eksperimenter, men uten full tilfeldig tilordning."),
    rebuilt_question("Balansering: kausalitet og design", "Hva er hovedsvakheten ved å sammenligne samme gruppe før og etter en hendelse uten kontrollgruppe?", "Andre samtidige endringer kan forklare forskjellen.", ["Det finnes ingen tidsrekkefølge.", "Y kan ikke måles to ganger.", "Gjennomsnitt kan ikke beregnes.", "Alle observasjoner er uteliggere."], "Uten sammenligningsgruppe er det vanskelig å vite om endringen skyldes behandlingen eller noe annet."),
    rebuilt_question("Balansering: kausalitet og design", "Hva hjelper enhetsfaste effekter spesielt med i paneldata?", "Å kontrollere for stabile forskjeller mellom enheter.", ["Å kontrollere automatisk for alle endringer over tid.", "Å gjøre utvalget tilfeldig trukket.", "Å fjerne behovet for standardfeil.", "Å gjøre alle variabler binære."], "Enhetsfaste effekter fjerner tidstabile kjennetegn ved enhetene."),
    rebuilt_question("Balansering: kausalitet og design", "Hvorfor er en kausalmekanisme nyttig?", "Den forklarer hvordan X kan påvirke Y.", ["Den erstatter behovet for data.", "Den gjør alle p-verdier små.", "Den viser bare hvor mange observasjoner vi har.", "Den er det samme som en residual."], "En troverdig mekanisme gjør en kausal påstand mer plausibel."),
    rebuilt_question("Balansering: kausalitet og design", "Hva er et tegn på seleksjonsproblem i en studie av tiltak?", "De som får tiltaket skiller seg systematisk fra de som ikke får det.", ["Alle får tilfeldig behandling.", "Alle har samme X-verdi.", "Data har for mange variabler.", "Figuren bruker få farger."], "Seleksjon oppstår når grupper ikke er sammenlignbare før behandling."),
    rebuilt_question("Balansering: kausalitet og design", "Hvorfor er kontrollvariabler ikke bare noe man legger inn flest mulig av?", "Noen kontroller kan være mediatorer eller introdusere feil tolkning.", ["Flere kontroller gir alltid sann kausal effekt.", "Kontrollvariabler gjør p-verdier irrelevante.", "Kontrollvariabler kan bare være avhengige variabler.", "Alle kontroller må være grafiske."], "Kontrollvariabler bør velges ut fra teori og kausal logikk."),
    rebuilt_question("Balansering: kausalitet og design", "Hva er en kontrafaktisk sammenligning?", "En sammenligning med hva utfallet ville vært uten en annen verdi på årsaksvariabelen.", ["En sammenligning av to p-verdier.", "En graf uten akser.", "En variabel som alltid er nominal.", "En observasjon med høy leverage."], "Kausal effekt handler om forskjellen mellom faktisk og kontrafaktisk utfall."),
    rebuilt_question("Balansering: kausalitet og design", "Hva er hovedideen bak å bruke kontrollvariabler i en observasjonsstudie?", "Å redusere faren for at bakenforliggende variabler forveksles med effekten av X.", ["Å gjøre alle variabler like null.", "Å øke R² uten teori.", "Å fjerne alle observasjoner med høy Y.", "Å erstatte utfallsmålet med en p-verdi."], "Kontrollvariabler brukes for å håndtere alternative forklaringer, særlig variabler som påvirker Y og samvarierer med X."),
    rebuilt_question("Balansering: visualisering og deskriptiv", "Hvorfor bør søylediagrammer ofte starte y-aksen på null?", "Fordi avkortet akse kan overdrive forskjeller mellom søyler.", ["Fordi alle variabler er forholdstall.", "Fordi p-verdien ellers ikke kan beregnes.", "Fordi standardfeilen blir null.", "Fordi søylediagrammer bare brukes i eksperimenter."], "Søyler tolkes som lengder/volum, så avkortet akse kan villede."),
    rebuilt_question("Balansering: visualisering og deskriptiv", "Hva kan skje hvis et histogram har altfor få intervaller?", "Viktige mønstre i fordelingen kan skjules.", ["Alle observasjoner blir kausale.", "Medianen forsvinner fra datasettet.", "X blir automatisk nominal.", "R² blir negativ."], "Valg av bin-bredde påvirker hvor detaljert fordelingen vises."),
    rebuilt_question("Balansering: visualisering og deskriptiv", "Et spredningsdiagram viser en tydelig kurvet sammenheng. Hva bør forskeren være oppmerksom på?", "En ren lineær modell kan beskrive mønsteret dårlig.", ["Korrelasjon er nødvendigvis perfekt.", "Kakediagram er alltid best.", "Y må være nominal.", "Utvalget er nødvendigvis representativt."], "Lineære modeller fanger rette linjer; kurver kan kreve annen modellering eller transformasjon."),
    rebuilt_question("Balansering: visualisering og deskriptiv", "Hva er beste graf for å vise utvikling i demokratiscore for Norge fra 1950 til 2020?", "Linjediagram.", ["Kakediagram.", "Krysstabell.", "Boksplott uten år.", "Et enkelt standardavvik."], "Linjediagram egner seg for ordnede tidspunkter og utvikling over tid."),
    rebuilt_question("Balansering: visualisering og deskriptiv", "Hva viser en logaritmisk skala best sammenlignet med en vanlig lineær skala?", "Relative eller proporsjonale endringer.", ["Bare nominale kategorier.", "At p-verdien er lav.", "At effekten er kausal.", "At alle verdier er null."], "På log-skala representerer like avstander like relative endringer."),
    rebuilt_question("Balansering: visualisering og deskriptiv", "Hva er mest passende mål på sentraltendens for inntekt når noen få har ekstremt høy inntekt?", "Median.", ["Gjennomsnitt alene.", "Maksimum.", "R².", "Kjikvadrat."], "Medianen er ofte mer robust enn gjennomsnittet ved høyreskjeve inntektsfordelinger."),
    rebuilt_question("Balansering: visualisering og deskriptiv", "Hva beskriver variasjonsbredde?", "Forskjellen mellom høyeste og laveste observerte verdi.", ["Forskjellen mellom p-verdi og R².", "Andelen forklart variasjon.", "Standardfeilen til koeffisienten.", "Antall kontrollvariabler."], "Variasjonsbredde er maksimum minus minimum."),
    rebuilt_question("Balansering: måling og bivariat", "Hvilket målenivå har partitilhørighet uten rangering?", "Nominalnivå.", ["Ordinalnivå.", "Intervallnivå.", "Forholdstallsnivå.", "Standardfeilnivå."], "Partitilhørighet er kategorier uten naturlig orden."),
    rebuilt_question("Balansering: måling og bivariat", "Hvilket målenivå har en fempunktsskala fra 'helt uenig' til 'helt enig'?", "Ordinalnivå.", ["Nominalnivå.", "Forholdstallsnivå.", "Residualnivå.", "R²-nivå."], "Svarene kan rangeres, men avstanden mellom kategoriene er ikke nødvendigvis kjent."),
    rebuilt_question("Balansering: måling og bivariat", "Hvilket målenivå har alder målt i år?", "Forholdstallsnivå.", ["Nominalnivå.", "Ordinalnivå uten avstand.", "Residualnivå.", "Kategorisk nivå uten nullpunkt."], "Alder har meningsfullt nullpunkt og like avstander."),
    rebuilt_question("Balansering: måling og bivariat", "Hvorfor bruker man ofte prosenter i en krysstabell?", "For å gjøre grupper med ulik størrelse lettere å sammenligne.", ["For å bevise kausalitet.", "For å fjerne behovet for teori.", "For å gjøre alle variabler kontinuerlige.", "For å erstatte observasjoner med residualer."], "Prosenter gjør fordelinger sammenlignbare når gruppestørrelser varierer."),
    rebuilt_question("Balansering: måling og bivariat", "Hva sammenligner kjikvadrattesten i en krysstabell?", "Observerte frekvenser med forventede frekvenser ved uavhengighet.", ["To regresjonskoeffisienter med hverandre.", "Median med gjennomsnitt.", "Standardfeil med R².", "Random sampling med random assignment."], "Kjikvadrattesten undersøker om cellefordelingen avviker fra uavhengighet."),
    rebuilt_question("Balansering: måling og bivariat", "To kodere bruker samme kodebok og kommer nesten alltid til samme resultat. Hva tyder det på?", "Høy reliabilitet.", ["Høy R².", "Lav ekstern validitet.", "Perfekt kausalitet.", "Heteroskedastisitet."], "Enighet mellom uavhengige kodere er et tegn på reliabel måling."),
]
