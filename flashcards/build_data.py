...
BALANCING_APPLICATION_QUESTIONS = [
    ...
    rebuilt_question("Balansering: kausalitet og design", "Hva kan være problemet med å kontrollere for en variabel som kommer etter behandlingen?", "Man kan kontrollere bort en del av effekten eller skape feil tolkning.", ["Man får alltid bedre total effekt.", "Man sikrer random sampling.", "Man gjør standardfeilen null.", "Man unngår all målefeil."], "Post-treatment-kontroller kan ligge på kausalveien og endre hva estimatet betyr."),
    ...
    rebuilt_question("Balansering: kausalitet og design", "Hva kjennetegner en naturlig eksperiment-lignende situasjon?", "En ekstern hendelse eller regel skaper variasjon som kan ligne tilfeldig behandling.", ["Forskeren velger alltid selv hvem som får behandling.", "Alle variabler må være nominale.", "Det finnes aldri kontrollgruppe.", "Data kan ikke analyseres statistisk."], "Naturlige eller kvasi-eksperimentelle design utnytter variasjon forskeren ikke fullt ut kontrollerer."),
    ...
    rebuilt_question("Balansering: kausalitet og design", "Hva er hovedideen bak matching som observasjonelt design?", "Å sammenligne enheter som ligner på relevante bakgrunnsvariabler.", ["Å gjøre alle variabler like null.", "Å øke R² uten teori.", "Å fjerne alle observasjoner med høy Y.", "Å erstatte utfallsmålet med en p-verdi."], "Matching forsøker å gjøre behandlings- og sammenligningsenheter mer like på observerte kjennetegn."),
